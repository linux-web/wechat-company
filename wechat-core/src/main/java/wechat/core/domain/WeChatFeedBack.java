...
public class WeChatFeedBack {
	...
	public String toString() {
		return "WeChatFeedBackDto [OpenId=" + OpenId + ", AppId=" + AppId + ", TimeStamp=" + TimeStamp + ", MsgType="
				+ MsgType + ", Phone=" + Phone + ", FeedBackId=" + FeedBackId + ", TransId=" + TransId + ", Reason="
				+ Reason + ", Solution=" + Solution + ", ExtInfo=" + ExtInfo + ", AppSignature=" + AppSignature
				+ ", SignMethod=" + SignMethod + "]";
	}
