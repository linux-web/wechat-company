...
import wechat.core.domain.Article;
import wechat.core.domain.Articles;
import wechat.core.domain.TemplateData;
...
public class Message {
	 ...
	 * @throws IOException
	 */
	public JSONObject massSendall(String accessToken, String groupId, String mpNewsMediaId) throws IOException,
	 ...
	 */
	public JSONObject massSend(String accessToken, String[] openids, String mpNewsMediaId) throws IOException,
