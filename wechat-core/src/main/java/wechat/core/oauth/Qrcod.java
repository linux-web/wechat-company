...
public class Qrcod {
	 ...
	 * @throws IOException
	 */
	public JSONObject createScene(String accessToken, int expireSeconds, int sceneId) throws InterruptedException,
	 ...
	 * @throws IOException
	 */
	public JSONObject createLimitScene(String accessToken, int sceneId) throws InterruptedException,
			ExecutionException, IOException {
		Map<String, Object> params = new HashMap<String, Object>();
		Map<String, Object> actionInfo = new HashMap<String, Object>();
		Map<String, Object> scene = new HashMap<String, Object>();
